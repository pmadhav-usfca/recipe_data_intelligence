...
from config.user_definition import *
...
def _download_all_recipes_data():
    ...
    if recipe_list_csv_file.exists():
    ...
    if len(url_list) > index:
        (
            ...
            failed_urls,
            new_url_list,
        ) = all_recipes_scrape_recipe_page(
            url_list, index, all_recipes_api_url, n_recipes
        )
...
with DAG(
    ...
    download_all_recipes_data = PythonOperator(
        task_id="download_all_recipes_data",
